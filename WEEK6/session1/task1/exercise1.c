...
int get_speed_limit(int speed_limit) {
...
int get_driver_speed(int driver_speed) {
...
int main() {
  ...
  speed_limit = get_speed_limit(speed_limit);

  driver_speed = get_driver_speed(driver_speed);
